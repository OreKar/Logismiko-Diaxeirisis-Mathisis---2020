...
$string['choosereadme'] = 'Theme ergasiatheme is a child theme of the Classic. It adds the ability to upload background photos.';
// Name of the settings pages.
$string['configtitle'] = 'ergasiatheme settings';
...
$string['pluginname'] = 'ergasiatheme';
