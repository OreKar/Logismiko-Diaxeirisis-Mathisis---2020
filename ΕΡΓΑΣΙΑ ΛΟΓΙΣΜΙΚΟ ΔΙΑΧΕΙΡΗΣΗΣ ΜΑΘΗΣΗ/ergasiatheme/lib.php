 ...
 */
function theme_ergasiatheme_get_main_scss_content($theme) {
    global $CFG;
    ...
    $pre = file_get_contents($CFG->dirroot . '/theme/ergasiatheme/scss/pre.scss');

    // Post CSS - this is loaded AFTER the main scss but before the extra scss from the setting.
    $post = file_get_contents($CFG->dirroot . '/theme/ergasiatheme/scss/post.scss');
 ...
 */
function theme_ergasiatheme_get_pre_scss($theme) {
 ...
 * @return bool
 */
function theme_ergasiatheme_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && strpos($filearea, 'backgroundimage')) {
        $theme = theme_config::load('ergasiatheme');
